...
def homework_builder(bot_approved: bool):
    bot_or_teacher = IKB(
        text="Отправить преподавателю", callback_data="homework:send_report"
    ) if bot_approved else IKB(
        text="Проверка ботом", callback_data="homework:bot_check"
    )
...
def labwork(sem: int):
    if sem == 1:
        ...
        raise ValueError(f"got invalid semester's number: {sem}")
...
homework_t = InlineKeyboardMarkup(inline_keyboard=[
    [
...
homework_choice = InlineKeyboardMarkup(inline_keyboard=[
    [
...
homework_approve_or_remark = InlineKeyboardMarkup(inline_keyboard=[
    [
...
labs_action_t = InlineKeyboardMarkup(inline_keyboard=[
    [
...
labs_choice_t = InlineKeyboardMarkup(inline_keyboard=[
    [
...
labs_approve_or_remark = InlineKeyboardMarkup(inline_keyboard=[
    [
...
students_actions = InlineKeyboardMarkup(inline_keyboard=[
    [
...
update_groups = InlineKeyboardMarkup(inline_keyboard=[
    [
